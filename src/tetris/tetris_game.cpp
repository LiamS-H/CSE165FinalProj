...
tetris_game::tetris_game() {
    ...
    int window_height = this->border_size * 2 + this->board_height * this->tile_size;
    int window_width = this->border_size * 2 + this->board_width * this->tile_size;

    this->game_window = new game(window_width, window_height);
